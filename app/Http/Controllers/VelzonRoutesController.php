...
class VelzonRoutesController extends Controller
{
    ...
    {
        return Inertia::render('SalesRepDashboard/index', [
            'title' => 'Satış Temsilcisi Paneli'
        ]);
    }
    ...
    public function apps_ecommerce_shop()
    {
        return Inertia::render('Ecommerce/EcommerceShop');
    }
    ...
    {
        return app(\App\Http\Controllers\FileManager\FileManagerController::class)->index(request());
    }

    public function apps_todo()
    {
        return app(\App\Http\Controllers\Todo\TodoController::class)->index(request());
    }
