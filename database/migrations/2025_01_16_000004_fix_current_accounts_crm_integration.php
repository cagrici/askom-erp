...
return new class extends Migration
{
    ...
    {
        // Önce mevcut column'ların varlığını kontrol et
        ...
        if (!Schema::hasTable('current_account_delivery_addresses')) {
        ...
        if (!Schema::hasTable('current_account_contacts')) {
        ...
        if (!Schema::hasTable('current_account_credit_terms')) {
