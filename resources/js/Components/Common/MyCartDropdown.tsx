...
const MyCartDropdown = () => {
    ...
    const cartData = [
        { id: 1, img: image1, product: "Yeşil T-Shirts", quantity: 10, price: 32 },
        { id: 2, img: image2, product: "Masa Chair", quantity: 5, price: 18 },
                ...
                <Dropdown.Menu className="dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                    ...
                    <div className="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                        <Row className="align-items-center">
                            <Col>
                                <h6 className="m-0 fs-16 fw-semibold"> {t('My Cart')}</h6>
                            </Col>
                            <div className="col-auto">
                                <span className="badge bg-warning-subtle  text-warning fs-13"><span className="cartitem-badge"> {cartItem} </span> {t('items')}</span>
                            </div>
                        </Row>
                    </div>
                    <SimpleBar style={{ maxHeight: "300px" }}>
                        <div className="p-2">
                            <div className="text-center empty-cart" id="empty-cart" style={{ display: "none" }}>
                                ...
                                <h5 className="mb-3">{ t('Your Cart is Empty')}</h5>
                                <Link href="/apps-ecommerce-products" className="btn btn-success w-md mb-3">{t('Shop Now')}</Link>
                            </div>
                    ...
                    <div className="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border" id="checkout-elem">
                        <div className="d-flex justify-content-between align-items-center pb-3">
                            <h5 className="m-0 text-muted">{t('Total')}:</h5>
                            <div className="px-2">
