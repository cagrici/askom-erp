...
export default function Edit({ bankAccount }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(route('accounting.bank-accounts.update', bankAccount.id));
    };
    ...
    return (
        <Layout title={`Düzenle - ${bankAccount.account_name}`}>
            <Head title={`Düzenle - ${bankAccount.account_name}`} />
            <div className="page-content">
                <div className="container-fluid">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 className="h3 mb-0">Banka Hesabı Düzenle</h1>
                            <p className="text-muted mb-0">{bankAccount.account_name}</p>
                        </div>
                        <div>
                            <Button 
                                variant="outline-secondary"
                                href={route('accounting.bank-accounts.show', bankAccount.id)}
                                as="a"
                                className="me-2"
                            >
                    ...
                    <Row>
                        ...
                        <Col lg={4}>
                            ...
                            <Card className="mb-4">
                                ...
                                <Card.Body>
                                    ...
                                    <div className="mb-2">
                                        ...
                                        <small className="text-muted">{formatDate(bankAccount.created_at)}</small>
                                    </div>
                                    <div className="mb-2">
                                        <strong>Son Güncelleme:</strong><br />
                                        <small className="text-muted">{formatDate(bankAccount.updated_at)}</small>
                                    </div>
                                </Card.Body>
                            </Card>
                            ...
                            <Alert variant="warning">
                                ...
                                <strong>Uyarı:</strong> Bu hesabı kullanan tahsilat kayıtları varsa, hesap bilgilerini değiştirmek mevcut kayıtları etkileyebilir.
                            </Alert>
                        </Col>
                    </Row>
                </div>
