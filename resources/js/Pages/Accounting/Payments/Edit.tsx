...
export default function Edit({ 
    ...
    const { data, setData, patch, processing, errors, reset } = useForm<FormData>({
        current_account_id: payment.current_account_id.toString(),
        bank_account_id: payment.bank_account_id.toString(),
        payment_method_id: payment.payment_method_id.toString(),
        payment_term_id: payment.payment_term_id?.toString() || '',
        amount: payment.amount.toString(),
        currency: payment.currency,
        exchange_rate: payment.exchange_rate.toString(),
        commission_rate: payment.commission_rate.toString(),
        bank_fees: payment.bank_fees.toString(),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(route('accounting.payments.update', payment.id));
    };
    ...
    return (
        <Layout title={`Düzenle - ${payment.payment_number}`}>
            <Head title={`Düzenle - ${payment.payment_number}`} />
            <div className="page-content">
                <div className="container-fluid">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 className="h3 mb-0">Ödeme Düzenle</h1>
                    ...
                    <Row>
                        ...
                        <Col lg={4}>
                            <Card className="mb-4">
                                ...
                                <Card.Body>
                                    <div className="mb-3">
                                        <strong>Ödeme Numarası:</strong><br />
                                        <span className="text-muted">{payment.payment_number}</span>
                                    </div>
                            ...
                            <Alert variant="warning">
                                ...
                                <strong>Uyarı:</strong> Bu ödemeyi güncellemek mevcut iş akışını etkileyebilir. Önemli değişiklikler yaparken dikkatli olun.
                            </Alert>
                        </Col>
                    </Row>
                </div>
