...
export default function Create({ users, roles, samplePages }: CreateProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.login-redirects.store'));
    };
    ...
    return (
        <AdminLayout>
            <Head title={t('Create Login Redirect')} />
            <div className="page-content">
                <div className="container-fluid px-4">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h1 className="h3 mb-0 text-gray-800">{t('Create Login Redirect')}</h1>
