...
export default function ForgotPassword({ status }: any) {
    ...
    const submit = (e: any) => {
        ...
        console.log('Available routes:', window.route().current());
        console.log('All routes:', Object.keys(window.route().routes || {}));
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">{t('Wait, I remember my password...')} <Link href={route('login')} className="fw-semibold text-primary text-decoration-underline"> {t('Click here')} </Link> </p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
