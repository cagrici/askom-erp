...
export default function Register() {
    ...
    return (
        <React.Fragment>
            <GuestLayout>
                <Head title="Basic SignUp | UyumPro B2B Paneli" />
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    <Card.Body className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">{ t('Create an account for Portal')}</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <form onSubmit={submit}>
                                                <div>
                                                    <Form.Label htmlFor="email" value="Email" className='form-label'> {t('Email')} </Form.Label>
                                                ...
                                                <div className="mt-4">
                                                    <Form.Label htmlFor="name" value="Username" > {t('Username')} </Form.Label>
                                                    <span className="text-danger ms-1">*</span>
                                                ...
                                                <div className="mt-4">
                                                    <Form.Label htmlFor="password" value="Password" className='form-label'> {t('Password')} </Form.Label>
                                                    <span className="text-danger ms-1">*</span>
                                                    <Form.Control
                                                        id="password"
                                                        type="password"
                                                ...
                                                <div className="mt-4">
                                                    <Form.Label htmlFor="password_confirmation" value={t('Confirm Password')} className='form-label'> {t('Confirm Password')} </Form.Label>
                                                    <span className="text-danger ms-1">*</span>
                                                ...
                                                <div className="mb-4 mt-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Portal
                                                        <Link href="#" className="text-primary text-decoration-underline fst-normal fw-medium ms-2"> {t('Terms of Use')}</Link></p>
                                                </div>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">{t('Already have an account ?')} <Link href={route('login')} className="fw-semibold text-primary text-decoration-underline"> {t('Sign In')} </Link> </p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
