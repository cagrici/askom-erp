                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                    ...
                                    <Card.Body className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <form action="#">
                                                ...
                                                <div className="mb-3">
                                                    <Form.Label htmlFor="username" className="form-label">{t('Username')}</Form.Label>
                                                    <Form.Control type="text" className="form-control" id="username" placeholder="{t('Enter username')}" />
                                                </div>

                                                <div className="mb-3">
                                                    <div className="float-end">
                                                        <Link href="/auth-pass-reset-basic" className="text-muted">{t('Forgot password?')}</Link>
                                                    </div>
                                                ...
                                                <div className="form-check">
                                                    ...
                                                    <Form.Check.Label className="form-check-label" htmlFor="auth-remember-check">{t('Remember me')}</Form.Check.Label>
                                                </div>

                                                <div className="mt-4">
                                                    <Button variant="link" href="/dashboard" className="text-white btn btn-secondary w-100" type="submit">{t('Sign In')}</Button>
                                                </div>

                                                <div className="mt-4 text-center">
                                                    <div className="signin-other-title">
                                                        <h5 className="fs-13 mb-4 title">{ t('Sign In with')}</h5>
                                                    </div>
                                                    <div>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">{t('Don\'t have an account ?')} <Link href="/auth-signup-basic" className="fw-semibold text-primary text-decoration-underline"> {t('Signup')} </Link> </p>
                                </div>
