                                            ...
                                            <Col lg={6}>
                                                <div className="p-lg-5 p-4 text-center">
                                                    ...
                                                    <div className="mt-4 pt-2">
                                                        ...
                                                        <div className="mt-4">
                                                            <Link href="/auth-signin-basic" className="btn btn-secondary w-100">{t('Sign In')}</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </Col>
                            ...
                            <Row>
                                <Col lg={12}>
                                    <div className="text-center">
                                        <p className="mb-0">&copy; {new Date().getFullYear()} UyumPro. Crafted with <i className="mdi mdi-heart text-danger"></i> by COD Solutions</p>
                                    </div>
                                </Col>
                            </Row>
                        </Container>
