...
const BasicPasswCreate = () => {
    ...
    return (
        <GuestLayout>
            <Head title = "Create New Password | UyumPro B2B Paneli"/>
                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                            <Card className="mt-4">
                                ...
                                <Card.Body className="p-4">
                                    <div className="text-center mt-2">
                                        <h5 className="text-primary">{t('Create new password')}</h5>
                                        <p className="text-muted">{t('Your new password must be different from previous used password.')}</p>
                                    </div>
                                    ...
                                    <div className="p-2">
                                        <Form onSubmit={validation.handleSubmit} action="/auth-signin-basic">
                                            ...
                                            <div className="mt-4">
                                                <Button className="w-100 btn-secondary" type="submit">{t('Reset Password')}</Button>
                                            </div>
                                        </Form>
                                    </div>
                                </Card.Body>
                            ...
                            <div className="mt-4 text-center">
                                <p className="mb-0">{t('Wait, I remember my password...')} <Link href="/auth-signin-basic" className="fw-semibold text-primary text-decoration-underline"> {t('Click here')} </Link> </p>
                            </div>
                        </Col>
                    </Row>
                </Container>
