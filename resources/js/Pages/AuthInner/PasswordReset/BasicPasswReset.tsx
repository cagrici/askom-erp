                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">{t('Wait, I remember my password...')} <Link href="/auth-signin-basic" className="fw-bold text-primary text-decoration-underline"> {t('Click here')} </Link> </p>
                                </div>
