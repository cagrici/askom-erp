            ...
            <Col xs={12}>
              <Row>
                <Col xl={3}>
                  <Card className="card-h-100">
                    <Card.Body>
                      <button
                        ...
                        onClick={toggle}
                      >
                        <i className="mdi mdi-plus"></i> {t("Create New Event")}
                      </button>
                  ...
                  <div>
                    <h5 className="mb-1">{t("Upcoming Events")}</h5>
                    ...
                    <Card.Body className="bg-info-subtle">
                      <div className="d-flex">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <h6 className="fs-15">{t("Welcome to your Calendar!")}</h6>
                          <p className="text-muted mb-0">
                              {t("Event that applications book will appear here. Click on an event to see the details and manage applicants event.")}
                          </p>
                        </div>
                      </div>
                    </Card.Body>
