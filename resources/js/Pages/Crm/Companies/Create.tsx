...
const CompanyCreate: React.FC<CompanyCreateProps> = ({ industryTypes }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.post(route('companies.store'), processedData, {
      onSuccess: () => {
  ...
  return (
    <>
      <Head title="Yeni Şirket Ekle | Portal" />
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Yeni Şirket Ekle" pageTitle="Şirketler" />
...
CompanyCreate.layout = (page: any) => <Layout children={page} />;
