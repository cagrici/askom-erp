...
const ExpenseCategoryEdit = (props: EditProps) => {
    const { category, parentCategories } = props;
    ...
    return (
        <React.Fragment>
            <Head title="Harcama Kategorisi Düzenle | Portal" />
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Harcama Kategorisi Düzenle" pageTitle="Harcama Yönetimi" />
                                            ...
                                            <Col md={12}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Text className="text-muted">
                                                        Boş bırakırsanız kategorinin adından otomatik olarak üretilecektir.
                                                    </Form.Text>
                                                    {errors.slug && <Form.Control.Feedback type="invalid">{errors.slug}</Form.Control.Feedback>}
                                                </Form.Group>
                                            </Col>
                                        </Row>
...
ExpenseCategoryEdit.layout = (page: any) => <Layout children={page} />;
