...
const ExpenseCreate = (props: CreateProps) => {
    const { categories, departments, locations, user } = props;
    ...
    return (
        <React.Fragment>
            <Head title="Yeni Harcama | Portal" />
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Yeni Harcama" pageTitle="Harcama Yönetimi" />
...
ExpenseCreate.layout = (page: any) => <Layout children={page} />;
