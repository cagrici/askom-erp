...
const ExpenseReportCreate = (props: CreateProps) => {
    ...
    const handleExpenseSelection = (id: number, amount: number) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('expense-reports.store'));
    };
    ...
    return (
        <React.Fragment>
            <Head title="Yeni Harcama Raporu | Portal" />
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Yeni Harcama Raporu" pageTitle="Harcama Yönetimi" />
                                    ...
                                    <Form onSubmit={handleSubmit}>
                                                    ...
                                                    {expenses.length > 0 ? (
                                                        expenses.map((expense) => (
                                                            <tr 
                                                                ...
                                                                onClick={() => handleExpenseSelection(expense.id, expense.amount)}
                                        ...
                                        <div className="d-flex justify-content-end gap-2 mt-4">
                                            ...
                                            <Button type="submit" variant="primary" disabled={processing || selectedExpenses.length === 0}>
                                                <i className="ri-save-line align-bottom me-1"></i> Raporu Oluştur
                                            </Button>
                                        </div>
                                    </Form>
                                </Card.Body>
...
ExpenseReportCreate.layout = (page: any) => <Layout children={page} />;
