...
interface Vehicle {
    ...
    exhaust_inspection_date?: string;
    hgs_label_number?: string;
...
export default function Edit({ vehicle, locations, users }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        user_id: vehicle.user_id?.toString() || '',
        registration_number: vehicle.registration_number || '',
        license_serial_number: vehicle.license_serial_number || '',
        ...
        hgs_label_number: vehicle.hgs_label_number || '',
        have_winter_tires: vehicle.have_winter_tires || false,
        have_summer_tires: vehicle.have_summer_tires || false,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('logistics.vehicles.update', vehicle.id));
    };
            ...
            <div className="container-fluid py-4">
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <h4 className="mb-0">Arac Duzenle: {vehicle.plate_number}</h4>
                    </div>
                </div>
