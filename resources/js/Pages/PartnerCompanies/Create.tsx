...
interface PartnerCompanyCreateProps {
  categories: Category[];
  contacts: Contact[];
  errors?: {
    [key: string]: string;
...
const PartnerCompanyCreate: React.FC<PartnerCompanyCreateProps> = ({
  categories,
  contacts,
  errors = {}
}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      router.post(route('partner-companies.store'), formData);
    },
  });
  ...
  return (
    <React.Fragment>
      <Head title="Anlaşmalı Kurum Ekle | Portal" />
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Anlaşmalı Kurum Ekle" pageTitle="Anlaşmalı Kurumlar" />
                                    ...
                                    {({ getRootProps, getInputProps }) => (
                                      <div className="dropzone dz-clickable">
                                        ...
                                        >
                                          ...
                                          <h5>Logo yüklemek için buraya tıklayın veya sürükleyin</h5>
                                        </div>
                                      </div>
                                    )}
                                  </Dropzone>
                        ...
                        {formik.values.branches.length === 0 ? (
                          ...
                          <SimpleBar style={{ maxHeight: "400px" }}>
                            ...
                            <Button variant="primary" onClick={handleAddBranch}>
                              <i className="ri-add-line align-bottom me-1"></i> Şube Ekle
                            </Button>
...
PartnerCompanyCreate.layout = (page: React.ReactNode) => <Layout children={page} />;
export default PartnerCompanyCreate;
