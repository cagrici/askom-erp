...
interface CreateSupplierProps extends PageProps {
    personTypes: Array<{
        value: string;
        label: string;
    }>;
...
export default function Create({ personTypes }: CreateSupplierProps) {
    ...
    return (
        <Layout>
            <Head title="Yeni Tedarikçi Ekle" />
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    <h3 className="card-title">Yeni Tedarikçi Ekle</h3>
                                    <Link
