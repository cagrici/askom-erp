...
export default function Show({ priceList, types, currencies, customerGroups, userPermissions }: Props) {
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <Button 
                            ...
                            onClick={() => window.open(route('sales.price-lists.export', priceList.id), '_blank')}
                        >
                        ...
                        {userPermissions.canEdit && (
                            <Link href={route('sales.price-lists.import-form', priceList.id)}>
                            ...
                            <Card className="mb-4">
                                ...
                                <Card.Body>
                                    <div className="d-flex flex-wrap gap-2">
                                        {priceList.customer_groups?.map((groupValue) => {
                                            const group = customerGroups.find(g => g.value === groupValue);
                                            return (
                                                <Badge key={groupValue} bg="info" className="p-2">
                                                    {group?.label || groupValue}
                                                </Badge>
                                            );
                                        })}
                                    </div>
