...
const Edit: React.FC<Props> = ({ zone, warehouses }) => {
    const { data, setData, put, processing, errors } = useForm({
        ...
        max_locations: zone.max_locations || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('warehouses.zones.update', zone.id));
    };
    ...
    return (
        <Layout>
            <Head title="Depo Bölgesi Düzenle" />
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Depo Bölgesi Düzenle</h4>
