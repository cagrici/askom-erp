...
<head>
    ...
    <title>419 - Oturum Süresi Doldu | {{ config('app.name', 'Portal') }}</title>
...
<body>
    <div class="error-container">
        ...
        <p class="error-description">
            Güvenlik nedeniyle oturum süreniz dolmuş. Bu durum uzun süre işlem yapmadığınızda veya sayfayı uzun süre açık bıraktığınızda oluşur.
